...
and passing around the old meetinghouse, its venerable and plain appearance,
...
Now there are two meetinghouses, and two distinct societies, calling themselves Friends,
...
Several of our father`'s grandchildren, and my sister H. Rhoads,
...
On first-day morning the weather was fine, which made walking to the meetinghouse easy.
